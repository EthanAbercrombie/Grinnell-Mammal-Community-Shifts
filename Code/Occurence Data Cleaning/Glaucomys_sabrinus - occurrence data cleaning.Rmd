---
title: "Glaucomys_sabrinus - occurrence data cleaning"
...
species <- read.delim('C:/Grinnell-Mammal-Community-Shifts/Data/Species Occurrence Data/Glaucomys_sabrinus/occurrence.txt')
...
rangeMap <- st_read('C:/Grinnell-Mammal-Community-Shifts/Data/IUCN Species Ranges/Species Ranges_Exports_QGIS/Glaucomys_sabrinus/Glaucomys_sabrinus.shp')
```
...
#Evaluate the number of observations with 'Issue'
            ...
            grepl(c('COORDINATE_UNCERTAINTY_METERS_INVALID'),
                  issue
            ))
fi$gbifID

#Notes about what was removed, and how many, here.
#72 occurrences -> coordinate_rounded
#25 occurrence -> coordinate uncertainty meters invalid
...
#             "C:/Grinnell-Mammal-Community-Shifts/Data/Species Climate Data/Glaucomys_sabrinus_climate",
#             format = 'GTiff',
#             overwrite = T)

#Add path to tif file
climate_data <- stack('C:/Grinnell-Mammal-Community-Shifts/Data/Species Climate Data/Glaucomys_sabrinus_climate.tif')

#fill NA cells near coasts to account for fact that some records may not fall in a cell near a coast
	for (i in 1:nlayers(climate_data)) {
		climate_data[[i]] <- focal(climate_data[[i]],
...
hist(speciesSf_filtered$temperature)
#0 not included.
