---
title: "Brachylagus_idahoensis -- occurrence data cleaning"
...
species <- read.delim('C:/Grinnell-Mammal-Community-Shifts/Data/Species Occurrence Data/Brachylagus idahoensis/occurrence.txt')
...
rangeMap <- st_read('C:/Grinnell-Mammal-Community-Shifts/Data/IUCN Species Ranges/Species Ranges_Exports_QGIS/Brachylagus_idahoensis/Brachylagus_idahoensis.shp')
```
...
Filter data. Remove all occurrences with uncertaintity > 1000m. Remove all occurences collected before 1970.
...
#             "C:/Grinnell-Mammal-Community-Shifts/Data/Species Climate Data/Brachylagus_idahoensis_climate",
#             format = 'GTiff',
#             overwrite = T)

#Add path to tif file
climate_data <- stack('C:/Grinnell-Mammal-Community-Shifts/Data/Species Climate Data/Brachylagus_idahoensis_climate.tif')
```
...
hist(speciesSf_filtered$Brachylagus_idahoensis_climate.12)
#0 is excluded.

speciesSf_filtered <- st_as_sf(speciesSf_filtered) %>% 
  mutate(Annual_Temp = Brachylagus_idahoensis_climate.1 / 10,
         Annual_Precip = Brachylagus_idahoensis_climate.12 / 1000) %>% 
