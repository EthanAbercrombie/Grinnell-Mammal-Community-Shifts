---
title: "Dipodomys_heermanni - occurrence data cleaning"
...
species <- read.delim('C:/Grinnell-Mammal-Community-Shifts/Data/Species Occurrence Data/Dipodomys heermanni/GBIF/occurrence.txt')
...
rangeMap <- st_read('C:/Grinnell-Mammal-Community-Shifts/Data/IUCN Species Ranges/Species Ranges_Exports_QGIS/Dipodomys_heermanni/Dipodomys_heermanni.shp')
```
...
#Coordinate rounded -> 71 occurrences
...
writeRaster(climate_data,
            "C:/Grinnell-Mammal-Community-Shifts/Data/Species Climate Data/Dipodomys_heermanni_climate",
            format = 'GTiff',
            overwrite = T)

#Add path to tif file
climate_data <- stack('C:/Grinnell-Mammal-Community-Shifts/Data/Species Climate Data/Dipodomys_heermanni_climate.tif')
```
...
hist(speciesSf_filtered$bio12)
#Lowest precip is 174, NA values present (10/23/21)
