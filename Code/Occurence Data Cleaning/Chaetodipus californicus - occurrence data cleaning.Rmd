---
title: "Chaetodipus californicus - occurrence data cleaning"
...
species <- read.delim('C:/Grinnell-Mammal-Community-Shifts/Data/Species Occurrence Data/Chaetodipus californicus/GBIF/occurrence.txt')
...
rangeMap <- st_read('C:/Grinnell-Mammal-Community-Shifts/Data/IUCN Species Ranges/Species Ranges_Exports_QGIS/Chaetodipus_californicus/Chaetodipus_californicus.shp')
```
...
Filter data. Remove all occurrences with uncertainty > 1000m. Remove all occurences collected before 1970.
...
#Coordinate rounded: 154 occurrences removed.
...
#             "C:/Grinnell-Mammal-Community-Shifts/Data/Species Climate Data/Chaetodipus_californicus_climate",
#             format = 'GTiff',
#             overwrite = T)

#Add path to tif file
climate_data <- stack('C:/Grinnell-Mammal-Community-Shifts/Data/Species Climate Data/Chaetodipus_californicus_climate.tif')
```
...
hist(speciesSf_filtered$Chaetodipus_californicus_climate.12)
#0 excluded from data.

speciesSf_filtered <- st_as_sf(speciesSf_filtered) %>% 
  mutate(Annual_Temp = Chaetodipus_californicus_climate.1 / 10,
         Annual_Precip = Chaetodipus_californicus_climate.12 / 1000) %>% 
