---
title: "Dipodomys_panamintinus - occurrence data cleaning"
...
species <- read.delim('C:/Grinnell-Mammal-Community-Shifts/Data/Species Occurrence Data/Dipodomys panamintinus/GBIF/occurrence.txt')
...
rangeMap <- st_read('C:/Grinnell-Mammal-Community-Shifts/Data/IUCN Species Ranges/Species Ranges_Exports_QGIS/Dipodomys_panamintinus/Dipodomys_panamintinus.shp')
```
...
#             "C:/Grinnell-Mammal-Community-Shifts/Data/Species Climate Data/Dipodomys_panamintinus",
#             format = 'GTiff',
#             overwrite = T)

#Add path to tif file
climate_data <- stack('C:/Grinnell-Mammal-Community-Shifts/Data/Species Climate Data/Dipodomys_panamintinus.tif')
```
...
hist(speciesSf_filtered$Dipodomys_panamintinus.2)
#0 not included.

speciesSf_filtered <- st_as_sf(speciesSf_filtered) %>% 
  mutate(Annual_Temp = Dipodomys_panamintinus.1 / 10,
         Annual_Precip = Dipodomys_panamintinus.2 / 1000) %>% 
...
Write these occurrences to a new txt file that will be used in further analyses.

```{r}
write_delim(speciesSf_filtered,
            file = 'C:/Grinnell-Mammal-Community-Shifts/Data/Species Occurrence Data/Species Occurrence Data Cleaned/Dipodomys_panamintinus_occurrence_cleaned.txt')
```
