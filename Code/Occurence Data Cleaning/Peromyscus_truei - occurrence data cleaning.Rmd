...
species <- read.delim('E:/Data/Species Occurrence Data/Peromyscus_truei/occurrence.txt')
...
rangeMap <- st_read('E:/Data/IUCN Species Ranges/Species Ranges_Exports_QGIS/Peromyscus_truei/Peromyscus_truei.shp')
```
