---
title: "Aplodontia_rufa - occurrence data cleaning"
...
species <- read.delim('C:/Grinnell-Mammal-Community-Shifts/Data/Species Occurrence Data/Aplodontia rufa/occurrence.txt')
...
rangeMap <- st_read('C:/Grinnell-Mammal-Community-Shifts/Data/IUCN Species Ranges/Species Ranges_Exports_QGIS/Aplodontia_rufa/Aplodontia_rufa.shp')
```
...
#Coordinate Rounded error removed - 32 occurrences.
...
# range_tiles <- c(define tiles here)
# 
...
climate_data <- stack('C:/Grinnell-Mammal-Community-Shifts/Data/Species Climate Data/Aplodontia_rufa_climate.tif')
```
...
hist(speciesSf_filtered$Aplodontia_rufa_climate.12)
#0 is excluded.

speciesSf_filtered <- st_as_sf(speciesSf_filtered) %>% 
  mutate(Annual_Temp = Aplodontia_rufa_climate.1 / 10,
         Annual_Precip = Aplodontia_rufa_climate.12 / 1000) %>% 
