...
site_data_ <- site_data_ %>%
  ...
  distinct(site_name,
           .keep_all = TRUE) %>% 
  filter(site_name != 'SSHistoricMtGould', # Not species present in historical or modern era
         site_name != 'LAHistoricMillCreek') %>%  # Not included in Rowe et al. Analyses
  mutate(aggelev = round(aggelev))

LA_data <- filter(site_data_,
                  Region == 'LA')
nrow(LA_data)

YO_data <- filter(site_data_,
                  Region == 'YO')
nrow(YO_data)

SS_data <- filter(site_data_,
                  Region == 'SS')
nrow(SS_data)
...
# LA_data <- filter(site_data_climate,
#                   Region == 'LA')
# nrow(LA_data)
# 
# YO_data <- filter(site_data_climate,
#                   Region == 'YO')
# nrow(YO_data)
# 
# SS_data <- filter(site_data_climate,
#                   Region == 'SS')
# nrow(SS_data)
